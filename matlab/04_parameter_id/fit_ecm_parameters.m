...
text(0.1, 0.7, sprintf('R0 = %.4f Ohm', R0_opt), 'FontSize', 11);
text(0.1, 0.55, sprintf('R1 = %.4f Ohm', R1_opt), 'FontSize', 11);
text(0.1, 0.4, sprintf('C1 = %.0f F', C1_opt), 'FontSize', 11);
text(0.1, 0.25, sprintf('tau = %.1f s', tau_opt), 'FontSize', 11);
